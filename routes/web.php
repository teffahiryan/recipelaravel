...
// ** RECIPE **********************************************************************************************************************************************************************
    ...
    Route::prefix('/admin/recette')->name('recipe.')->controller(RecipeController::class)->middleware('auth')->group(function (){
...
// ** CATEGORIE **********************************************************************************************************************************************************************
    ...
    Route::prefix('/admin/categorie')->name('category.')->controller(CategoryController::class)->middleware('auth')->group(function(){
...
// ** INGREDIENT **********************************************************************************************************************************************************************
    ...
    Route::prefix('/admin/ingredient')->name('ingredient.')->controller(IngredientController::class)->middleware('auth')->group(function(){
